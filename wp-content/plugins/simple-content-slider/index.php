...
Plugin URI: http://tutzstyle.com/portfolio/simple-content-slider-slideshow/
...
function scontentslider_custom_menu_page(){ ?>
    ...
    <div class="wrap">
		...
		<?php
			...
			$external_plugin_url = 'http://tutzstyle.com/portfolio/simple-content-slider-and-slideshow-plugin-wordpress/';
		?>
